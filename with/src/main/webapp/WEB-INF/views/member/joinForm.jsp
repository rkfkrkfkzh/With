		...
		<form action="${pageContext.request.contextPath }/member/join"
			...
			<div class="container px-4 px-lg-5 mt-5 container1 col-md-6">
				...
				<div class="col-md-12 mb-3"
					style="text-align: right; padding-left: 15%; padding-right: 15%">
					<input type="text" required id="id" name="id"
						class="form-control w-100" placeholder="아이디">
				...
				<div class="col-md-12 mb-3"
					...
					<input type="password" id="pwd" required name="pwd"
						class="form-control w-100" placeholder="비밀번호">
					<div class="invalid-feedback">비밀번호가 다릅니다.</div>
				</div>
				<div class="col-md-12 mb-3"
					style="text-align: right; padding-left: 15%; padding-right: 15%">
					<input type="password" id="pwd2" required
						class="form-control w-100" placeholder="비밀번호 확인">
					<div class="invalid-feedback">비밀번호가 다릅니다.</div>
				</div>
				<div class="col-md-12 mb-3" style="text-align: right">
					<div style="padding-left: 15%; padding-right: 15%">
						<input type="text" id="name" required name="name"
							class="form-control w-100" placeholder="이름">
					</div>
				</div>
				<div class="col-md-12 mb-3"
					style="text-align: right; padding-left: 15%; padding-right: 15%">
					<input type="text" id="nick" required name="nick"
						class="form-control w-100" placeholder="닉네임">
				...
				<div class="col-md-12 mb-3"
					style="text-align: right; padding-left: 15%; padding-right: 15%">
					<input type="text" id="tel" required name="tel"
						class="form-control w-100" placeholder="휴대폰 번호( - 제외)">
