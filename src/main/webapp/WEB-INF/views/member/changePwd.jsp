		...
		<div class="container">
			<form action="/member/changePwd" method="post">
				<div class="mb-3 col-md-3">
					<label for="user_pwd" class="form-label">새로운 비밀번호</label> <input type="password" class="form-control" id="user_pwd" name="pwd" /> <span id="pwd1Result" class="msg"></span>
				</div>
				<div class="mb-3 col-md-3">
					<label for="pwdCheck" class="form-label">비밀번호 확인</label> <input type="password" class="form-control" id="pwdCheck" name="pwd2" /> <span id="pwd2Result" class="msg"></span>
				</div>
